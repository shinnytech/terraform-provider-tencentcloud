	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"backup_method": {
				...
				Optional:     true,
				Default:      "physical",
				ValidateFunc: validateAllowedStringValue([]string{"physical"}),
			...
			"backup_period_save_days": {
				Type:         schema.TypeInt,
				ValidateFunc: validateIntegerInRange(90, 3650),
				Optional:     true,
				Default:      400,
			...
			"backup_period_save_interval": {
				Type:         schema.TypeString,
				ValidateFunc: validateAllowedStringValue([]string{"weekly", "monthly", "quarterly", "yearly"}),
				Optional:     true,
				Default:      "monthly",
